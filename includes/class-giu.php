...
class GIU {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      GIU_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $giu    The string used to uniquely identify this plugin.
	 */
	protected $giu;
	...
	public function __construct() {
		if ( defined( 'GIU_VERSION' ) ) {
			$this->version = GIU_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-giu-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new GIU_Admin( $this->get_giu(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new GIU_Public( $this->get_giu(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    GIU_Loader    Orchestrates the hooks of the plugin.
	 */
