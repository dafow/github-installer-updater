 ...
 * @subpackage GithubInstallerUpdater/public
 */
...
class GIU_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $giu       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->giu, plugin_dir_url( __FILE__ ) . 'css/giu-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->giu, plugin_dir_url( __FILE__ ) . 'js/giu-public.js', array( 'jquery' ), $this->version, false );
